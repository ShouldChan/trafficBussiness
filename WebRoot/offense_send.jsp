...
<html>
	...
	<body class="o-page">
		<div id="page" >
			...
			<h2 class="title" align="center">机动车违章记录查询业务</h2>
			<div id="content" style="height: 450px;text-align: center;">
				
				<h2 class="title" style="text-align: left;">请输入车牌号码：</h2>
				
				<form action="selecttrafficoffense.action" method="post" id="offense" class="offenseForm">
					
					<input type="text" name="trafficoffense.plateNo" id="plateNo" placeholder="plateNo">
